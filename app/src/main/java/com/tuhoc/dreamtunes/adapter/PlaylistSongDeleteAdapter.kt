...
import com.tuhoc.dreamtunes.databinding.DeletePlaylistSongCardBinding
import com.tuhoc.dreamtunes.ui.home.HomeFragment

class PlaylistSongDeleteAdapter : RecyclerView.Adapter<PlaylistSongDeleteAdapter.SongViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SongViewHolder {
        val binding = DeletePlaylistSongCardBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class SongViewHolder(val binding: DeletePlaylistSongCardBinding) : RecyclerView.ViewHolder(binding.root)
